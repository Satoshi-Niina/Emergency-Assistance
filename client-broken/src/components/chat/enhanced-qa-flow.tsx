...
export default function EnhancedQAFlow({
  ...
  const [contextualQuestion, setContextualQuestion] =
    useState<ContextualQuestion | null>(null);
        ...
        <CardHeader className='pb-3'>
          ...
          {problemCategory && (
            <div className='flex items-center space-x-2 text-sm text-gray-600'>
              ...
              <Badge
                variant={
                  problemCategory.emergencyLevel === 'critical'
                    ? 'destructive'
                    : 'secondary'
                }
              >
                ...
                <Alert className='border-blue-200 bg-blue-50'>
                  ...
                  <AlertDescription className='text-blue-800'>
                    <div className='space-y-2'>
                      ...
                      {contextualQuestion.knowledgeReferences &&
                        contextualQuestion.knowledgeReferences.length > 0 && (
                          <div className='text-xs'>
                            <strong>参考:</strong>{' '}
                            {contextualQuestion.knowledgeReferences.join(', ')}
                          </div>
                        )}
                    </div>
                  </AlertDescription>
