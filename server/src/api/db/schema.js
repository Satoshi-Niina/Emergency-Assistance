...
exports.schema =
  exports.supportHistory =
  exports.historyImages =
  exports.historyItems =
  exports.baseDocuments =
  exports.machines =
...
exports.messages = (0, pg_core_1.pgTable)('messages', {
  ...
  isAiResponse: (0, pg_core_1.boolean)('is_ai_response')
    .notNull()
    .default(false),
  createdAt: (0, pg_core_1.timestamp)('created_at').defaultNow().notNull(),
});
...
exports.machines = (0, pg_core_1.pgTable)('machines', {
  ...
  machineTypeId: (0, pg_core_1.text)('machine_type_id')
    .notNull()
    .references(function () {
      return exports.machineTypes.id;
    }),
  createdAt: (0, pg_core_1.timestamp)('created_at').defaultNow().notNull(),
});
// 基礎データ（文書）テーブル
...
exports.supportHistory = (0, pg_core_1.pgTable)('support_history', {
  ...
  machineNumber: (0, pg_core_1.text)('machine_number').notNull(),
  machineTypeId: (0, pg_core_1.text)('machine_type_id').references(function () {
    return exports.machineTypes.id;
  }),
  machineId: (0, pg_core_1.text)('machine_id').references(function () {
