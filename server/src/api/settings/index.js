  ...
  try {
    ...
    if (method === 'POST' && action === 'rag') {
      ...
      const updatedSettings = {
        ...
        knowledgeBase: {
          enabled:
            body.knowledgeBase?.enabled !== undefined
              ? body.knowledgeBase.enabled
              : true,
          sources: body.knowledgeBase?.sources || [
            'documents',
            'troubleshooting',
            'knowledge-base',
          ],
        ...
        searchSettings: {
          ...
          includeMetadata:
            body.searchSettings?.includeMetadata !== undefined
              ? body.searchSettings.includeMetadata
              : true,
