...
const dbConfig = {
    connectionString: "postgresql://satoshi_niina:SecurePass2025ABC@emergencyassistance-db.postgres.database.azure.com:5432/emergency_assistance?sslmode=require",
    ...
    try {
        ...
        if (usersResult.rows.length > 0) {
            ...
            passwordResult.rows.forEach(user => {
                console.log(`- ${user.username}: ${user.password_type} (長さ: ${user.password_length})`);
            });
