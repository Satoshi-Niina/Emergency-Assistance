...
export const setupAuth: any = setupAuth;
import passport_1 from "passport";
import passport_local_1 from "passport-local";
...
function comparePasswords(supplied: any, stored) {
    return __awaiter(this, void 0, void 0, function () {
