...
exports.analyzeUserContext = analyzeUserContext;
exports.adjustSystemPromptForContext = adjustSystemPromptForContext;
/**
 * ユーザーの質問を分析してコンテキストを抽出
 */
function analyzeUserContext(userInput) {
 ...
 */
function adjustSystemPromptForContext(basePrompt, context) {
