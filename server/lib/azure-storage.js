...
class AzureStorageService {
    constructor() {
        ...
        Object.defineProperty(this, "blobPrefix", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        if (connectionString) {
            ...
            this.blobServiceClient = new storage_blob_1.BlobServiceClient(`https://${accountName}.blob.core.windows.net`, credential);
        }
        else {
            // Managed Identityを使用（Azure App Service上で動作）
            const credential = new identity_1.DefaultAzureCredential();
            this.blobServiceClient = new storage_blob_1.BlobServiceClient(`https://${accountName || 'your-storage-account'}.blob.core.windows.net`, credential);
        }
