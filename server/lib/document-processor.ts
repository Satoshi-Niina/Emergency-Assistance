...
export const extractPdfText: any = extractPdfText;
export const extractWordText: any = extractWordText;
export const extractExcelText: any = extractExcelText;
export const extractPptxText: any = extractPptxText;
export const extractTxtText: any = extractTxtText;
export const chunkText: any = chunkText;
export const processDocument: any = processDocument;
export const storeDocumentChunks: any = storeDocumentChunks;
export const findRelevantChunks: any = findRelevantChunks;
import url_1 from "url";
import path_1 from "path";
import fs_1 from "fs";
import canvas_1 from "canvas";
// import { Document, Packer, Paragraph, TextRun } from 'docx';
import mammoth from "mammoth";
import XLSX from "xlsx";
import sharp_1 from "sharp";
import adm_zip_1 from "adm-zip";
 ...
 */
function addEmbeddedImagesToSearchData(imagePaths: any, baseFileName: any, originalFileName) {
    return __awaiter(this, void 0, void 0, function () {
 ...
 */
function chunkText(text: any, metadata) {
    var chunks = [];
    var chunkNumber = 0;
