...
export default function RagSettingsPanel() {
  ...
  function v(cfg: RagConfig): string | null {
    if (cfg.chunkSize < 500 || cfg.chunkSize > 800)
      return '粒度は500–800にしてください';
    if (cfg.chunkOverlap < 50 || cfg.chunkOverlap > 100)
      return 'オーバーラップは50–100にしてください';
    if (cfg.chunkOverlap >= cfg.chunkSize)
      return 'オーバーラップは粒度より小さく';
  ...
  const on = (k: keyof RagConfig) => (e: any) =>
  ...
  return (
    <div className='p-4 rounded-lg border border-gray-200 bg-white shadow-sm'>
      ...
      <p className='text-sm text-gray-600 mb-4 font-semibold'>
        ...
        Generation）は、AIが質問に答える際に関連する文書を検索して、より正確で信頼性の高い回答を生成するための設定です。これらのパラメータを調整することで、検索精度と処理速度のバランスを最適化できます。
      </p>
