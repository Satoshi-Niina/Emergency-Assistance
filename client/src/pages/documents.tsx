  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [baseDataResult, historyResult, processedFilesResult] =
          await Promise.all([
            fetchBaseData(),
        ...
        if (processedFilesResult.success && processedFilesResult.data) {
          console.log(
            '✅ 処理済みファイル取得成功:',
            processedFilesResult.data.length + '件'
          );
