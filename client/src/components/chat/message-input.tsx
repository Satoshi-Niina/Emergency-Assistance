...
export default function MessageInput({
  ...
  const { recordedText, selectedText, draftMessage, setDraftMessage } =
    useChat();
      ...
      <form onSubmit={handleSubmit} className='flex items-center'>
        ...
        <div className='flex-1 flex items-center bg-white border border-blue-200 rounded-full px-3 py-1 shadow-inner'>
          {isMobile ? (
            ...
            <div className='flex-1 h-[48px] flex items-center relative'>
              {' '}
              {/* 高さを1.5倍に */}
              <Input
                ref={inputRef}
        ...
        <div className='md:hidden flex flex-col items-center ml-2'>
          <span className='text-xs font-medium text-indigo-700 mb-0.5'>
            カメラ
          </span>
          <Button
            type='button'
